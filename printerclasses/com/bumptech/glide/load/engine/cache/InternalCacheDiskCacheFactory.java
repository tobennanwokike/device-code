...
public final class InternalCacheDiskCacheFactory extends DiskLruCacheFactory {
   ...
   public InternalCacheDiskCacheFactory(Context var1, int var2) {
      this(var1, "image_manager_disk_cache", var2);
   }

   public InternalCacheDiskCacheFactory(final Context var1, final String var2, int var3) {
      super(new DiskLruCacheFactory.CacheDirectoryGetter() {
         public File getCacheDirectory() {
            File var2x = var1.getCacheDir();
            File var1x;
            if(var2x == null) {
               var1x = null;
            } else {
