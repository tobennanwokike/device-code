...
class NotificationCompatImplBase {
   ...
   public static RemoteViews applyStandardTemplate(Context var0, CharSequence var1, CharSequence var2, CharSequence var3, int var4, int var5, Bitmap var6, CharSequence var7, boolean var8, long var9, int var11, int var12, int var13, boolean var14) {
      ...
      RemoteViews var20 = new RemoteViews(var0.getPackageName(), var13);
      boolean var18 = false;
      boolean var17 = false;
      boolean var27;
      if(var11 < -1) {
      ...
      if(var28 && !var16) {
         if(var27) {
            var20.setInt(R.id.notification_background, "setBackgroundResource", R.drawable.notification_bg_low);
            var20.setInt(R.id.icon, "setBackgroundResource", R.drawable.notification_template_icon_low_bg);
         } else {
            var20.setInt(R.id.notification_background, "setBackgroundResource", R.drawable.notification_bg);
            var20.setInt(R.id.icon, "setBackgroundResource", R.drawable.notification_template_icon_bg);
         }
      }
      ...
      if(var6 != null) {
         if(var28) {
            var20.setViewVisibility(R.id.icon, 0);
            var20.setImageViewBitmap(R.id.icon, var6);
         } else {
            var20.setViewVisibility(R.id.icon, 8);
         }

         if(var5 != 0) {
            var11 = var21.getDimensionPixelSize(R.dimen.notification_right_icon_size);
            int var19 = var21.getDimensionPixelSize(R.dimen.notification_small_icon_background_padding);
            if(var16) {
               var22 = createIconWithBackground(var0, var5, var11, var11 - var19 * 2, var12);
               var20.setImageViewBitmap(R.id.right_icon, var22);
            } else {
               var20.setImageViewBitmap(R.id.right_icon, createColoredBitmap(var0, var5, -1));
            }

            var20.setViewVisibility(R.id.right_icon, 0);
         }
      } else if(var5 != 0) {
         var20.setViewVisibility(R.id.icon, 0);
         if(var16) {
            var22 = createIconWithBackground(var0, var5, var21.getDimensionPixelSize(R.dimen.notification_large_icon_width) - var21.getDimensionPixelSize(R.dimen.notification_big_circle_margin), var21.getDimensionPixelSize(R.dimen.notification_small_icon_size_as_large), var12);
            var20.setImageViewBitmap(R.id.icon, var22);
         } else {
            var20.setImageViewBitmap(R.id.icon, createColoredBitmap(var0, var5, -1));
         }
      }

      if(var1 != null) {
         var20.setTextViewText(R.id.title, var1);
      }

      boolean var25 = var18;
      if(var2 != null) {
         var20.setTextViewText(R.id.text, var2);
         var25 = true;
      }
      ...
      boolean var24;
      if(var3 != null) {
         var20.setTextViewText(R.id.info, var3);
         var20.setViewVisibility(R.id.info, 0);
         var25 = true;
         var24 = true;
      } else if(var4 > 0) {
         if(var4 > var21.getInteger(R.integer.status_bar_notification_info_maxnum)) {
            var20.setTextViewText(R.id.info, var21.getString(R.string.status_bar_notification_info_overflow));
         } else {
            NumberFormat var23 = NumberFormat.getIntegerInstance();
            var20.setTextViewText(R.id.info, var23.format((long)var4));
         }
         ...
         var20.setViewVisibility(R.id.info, 8);
         var24 = var27;
      }
      ...
      if(var7 != null) {
         var27 = var17;
         if(var28) {
            var20.setTextViewText(R.id.text, var7);
            if(var2 != null) {
               var20.setTextViewText(R.id.text2, var2);
               var20.setViewVisibility(R.id.text2, 0);
               var27 = true;
            } else {
               var20.setViewVisibility(R.id.text2, 8);
               var27 = var17;
            }
         }
      }
      ...
      if(var27 && var28) {
         if(var14) {
            float var15 = (float)var21.getDimensionPixelSize(R.dimen.notification_subtext_size);
            var20.setTextViewTextSize(R.id.text, 0, var15);
         }

         var20.setViewPadding(R.id.line1, 0, 0, 0, 0);
      }

      if(var9 != 0L) {
         if(var8 && var28) {
            var20.setViewVisibility(R.id.chronometer, 0);
            var20.setLong(R.id.chronometer, "setBase", SystemClock.elapsedRealtime() - System.currentTimeMillis() + var9);
            var20.setBoolean(R.id.chronometer, "setStarted", true);
         } else {
            var20.setViewVisibility(R.id.time, 0);
            var20.setLong(R.id.time, "setTime", var9);
         }
      ...
      var20.setViewVisibility(var11, var26);
      var11 = R.id.line3;
      if(var25) {
         var26 = 0;
      } else {
   ...
   private static RemoteViews generateContentViewMedia(Context var0, CharSequence var1, CharSequence var2, CharSequence var3, int var4, Bitmap var5, CharSequence var6, boolean var7, long var8, int var10, List var11, int[] var12, boolean var13, PendingIntent var14, boolean var15) {
      ...
      RemoteViews var18 = applyStandardTemplate(var0, var1, var2, var3, var4, 0, var5, var6, var7, var8, var10, 0, var16, true);
      var16 = var11.size();
      if(var12 == null) {
         var4 = 0;
      } else {
      ...
      if(var4 > 0) {
         for(var10 = 0; var10 < var4; ++var10) {
            if(var10 >= var16) {
               throw new IllegalArgumentException(String.format("setShowActionsInCompactView: action %d out of bounds (max %d)", new Object[]{Integer.valueOf(var10), Integer.valueOf(var16 - 1)}));
            }

            RemoteViews var17 = generateMediaActionButton(var0, (NotificationCompatBase.Action)var11.get(var12[var10]));
            var18.addView(R.id.media_actions, var17);
         }
      }

      if(var13) {
         var18.setViewVisibility(R.id.end_padder, 8);
         ...
         var18.setViewVisibility(R.id.end_padder, 0);
