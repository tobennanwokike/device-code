...
public class ViewPropertyAnimatorCompatSet {
   ...
   public void start() {
      if(!this.mIsStarted) {
         ViewPropertyAnimatorCompat var1;
         for(Iterator var2 = this.mAnimators.iterator(); var2.hasNext(); var1.start()) {
            var1 = (ViewPropertyAnimatorCompat)var2.next();
            ...
            if(this.mListener != null) {
               var1.setListener(this.mProxyListener);
            }
         }
