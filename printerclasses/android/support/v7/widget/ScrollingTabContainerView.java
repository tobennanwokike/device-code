...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
   ...
   public void animateToTab(int var1) {
      ...
      this.mTabSelector = new Runnable() {
         public void run() {
            int var2x = var2.getLeft();
            int var1 = (ScrollingTabContainerView.this.getWidth() - var2.getWidth()) / 2;
            ScrollingTabContainerView.this.smoothScrollTo(var2x - var1, 0);
   ...
   public void onMeasure(int var1, int var2) {
      ...
      var2 = this.mTabLayout.getChildCount();
      if(var2 <= 1 || var3 != 1073741824 && var3 != Integer.MIN_VALUE) {
         this.mMaxTabWidth = -1;
      } else {
         if(var2 > 2) {
   ...
   private class TabView extends LinearLayoutCompat implements OnLongClickListener {
      ...
      public boolean onLongClick(View var1) {
         ...
         int var2 = var5.getResources().getDisplayMetrics().widthPixels;
         Toast var7 = Toast.makeText(var5, this.mTab.getContentDescription(), 0);
         var7.setGravity(49, var6[0] + var3 / 2 - var2 / 2, var4);
         var7.show();
         return true;
      }
         ...
         if(var3 != null) {
            ...
            if(var4 != null) {
               if(this.mIconView == null) {
                  ...
                  LinearLayoutCompat.LayoutParams var5 = new LinearLayoutCompat.LayoutParams(-2, -2);
                  var5.gravity = 16;
            ...
            if(var1) {
               if(this.mTextView == null) {
                  AppCompatTextView var10 = new AppCompatTextView(this.getContext(), (AttributeSet)null, R.attr.actionBarTabTextStyle);
