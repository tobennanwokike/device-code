...
public class TintTypedArray {
   ...
   public ColorStateList getColorStateList(int var1) {
      ...
      if(this.mWrapped.hasValue(var1)) {
         ...
         if(var2 != 0) {
            var3 = AppCompatResources.getColorStateList(this.mContext, var2);
            if(var3 != null) {
               return var3;
            }
         }
      ...
      var3 = this.mWrapped.getColorStateList(var1);
      return var3;
   }
   ...
   public Drawable getDrawable(int var1) {
      ...
      if(this.mWrapped.hasValue(var1)) {
         int var2 = this.mWrapped.getResourceId(var1, 0);
         if(var2 != 0) {
            var3 = AppCompatResources.getDrawable(this.mContext, var2);
            return var3;
         }
      }

      var3 = this.mWrapped.getDrawable(var1);
      return var3;
   }
   ...
   public Drawable getDrawableIfKnown(int var1) {
      ...
      if(this.mWrapped.hasValue(var1)) {
         ...
         if(var1 != 0) {
            var2 = AppCompatDrawableManager.get().getDrawable(this.mContext, var1, true);
            return var2;
         }
      }
   ...
   public int getType(int var1) {
      if(VERSION.SDK_INT >= 21) {
         var1 = this.mWrapped.getType(var1);
      } else {
