...
public abstract class FragmentHostCallback extends FragmentContainer {
   ...
   void reportLoaderStart() {
      if(this.mAllLoaderManagers != null) {
         ...
         LoaderManagerImpl[] var4 = new LoaderManagerImpl[var2];

         int var1;
         for(var1 = var2 - 1; var1 >= 0; --var1) {
            var4[var1] = (LoaderManagerImpl)this.mAllLoaderManagers.valueAt(var1);
         }

         for(var1 = 0; var1 < var2; ++var1) {
            LoaderManagerImpl var3 = var4[var1];
            var3.finishRetain();
            var3.doReportStart();
         }
      }
   ...
   SimpleArrayMap retainLoaderNonConfig() {
      ...
      if(this.mAllLoaderManagers != null) {
         ...
         while(true) {
            ...
            LoaderManagerImpl var6 = var7[var9];
