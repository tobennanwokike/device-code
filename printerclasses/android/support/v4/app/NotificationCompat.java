...
public class NotificationCompat {
   ...
   static void addStyleToBuilderApi24(NotificationBuilderWithBuilderAccessor var0, NotificationCompat.Style var1) {
      if(var1 != null) {
         if(var1 instanceof NotificationCompat.MessagingStyle) {
            NotificationCompat.MessagingStyle var4 = (NotificationCompat.MessagingStyle)var1;
            ArrayList var9 = new ArrayList();
            ArrayList var5 = new ArrayList();
            ArrayList var3 = new ArrayList();
            ArrayList var6 = new ArrayList();
            ArrayList var7 = new ArrayList();
            Iterator var8 = var4.mMessages.iterator();

            while(var8.hasNext()) {
               NotificationCompat.Message var2 = (NotificationCompat.Message)var8.next();
               var9.add(var2.getText());
               var5.add(Long.valueOf(var2.getTimestamp()));
               var3.add(var2.getSender());
               var6.add(var2.getDataMimeType());
               var7.add(var2.getDataUri());
            }

            NotificationCompatApi24.addMessagingStyle(var0, var4.mUserDisplayName, var4.mConversationTitle, var9, var5, var3, var6, var7);
         } else {
   ...
   static Notification[] getNotificationArrayFromBundle(Bundle var0, String var1) {
      ...
      if(!(var4 instanceof Notification[]) && var4 != null) {
         ...
         var5 = (Notification[])((Notification[])var4);
      }
   ...
   public static class Action extends NotificationCompatBase.Action {
      ...
      public static final NotificationCompatBase.Factory FACTORY = new NotificationCompatBase.Factory() {
         public NotificationCompatBase.Action build(int var1, CharSequence var2, PendingIntent var3, Bundle var4, RemoteInputCompatBase.RemoteInput[] var5, boolean var6) {
            return new NotificationCompat.Action(var1, var2, var3, var4, (RemoteInput[])((RemoteInput[])var5), var6);
         }
   ...
   public static class Builder {
      ...
      public NotificationCompat.UnreadConversation build() {
         String[] var7 = (String[])this.mMessages.toArray(new String[this.mMessages.size()]);
         String var6 = this.mParticipant;
         RemoteInput var4 = this.mRemoteInput;
         PendingIntent var3 = this.mReplyPendingIntent;
         PendingIntent var5 = this.mReadPendingIntent;
         long var1 = this.mLatestTimestamp;
         return new NotificationCompat.UnreadConversation(var7, var4, var3, var5, new String[]{var6}, var1);
      }
