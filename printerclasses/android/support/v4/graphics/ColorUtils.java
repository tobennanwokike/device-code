...
public final class ColorUtils {
   ...
   to = 255L
      ...
      float var4 = Math.max(var9, Math.max(var6, var8));
      float var10 = Math.min(var9, Math.min(var6, var8));
      float var5 = var4 - var10;
      float var7 = (var4 + var10) / 2.0F;
      if(var4 == var10) {
         var4 = 0.0F;
         var5 = 0.0F;
      } else {
   ...
   to = 1.0D
      ...
      float var8 = (float)Color.alpha(var0);
      float var9 = (float)Color.alpha(var1);
      float var3 = (float)Color.red(var0);
      float var5 = (float)Color.red(var1);
      float var6 = (float)Color.green(var0);
      float var4 = (float)Color.green(var1);
      float var11 = (float)Color.blue(var0);
      float var10 = (float)Color.blue(var1);
      return Color.argb((int)(var8 * var7 + var9 * var2), (int)(var3 * var7 + var5 * var2), (int)(var6 * var7 + var4 * var2), (int)(var11 * var7 + var10 * var2));
   }
