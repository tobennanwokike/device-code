...
public class ViewPager extends ViewGroup {
   ...
   private void completeScroll(boolean var1) {
      ...
      if(var2) {
         ...
         if(var3) {
            ...
            if(var6 != var4 || var5 != var9) {
               this.scrollTo(var4, var9);
               if(var4 != var6) {
   ...
   private int determineTargetPage(int var1, float var2, int var3, int var4) {
      ...
      if(this.mItems.size() > 0) {
         ...
         var3 = Math.max(var7.position, Math.min(var1, var6.position));
      }
   ...
   private ViewPager.ItemInfo infoForCurrentScrollPosition() {
      ...
      while(true) {
         ...
         if(var1 < var3 + var4 + var2 || var8 == this.mItems.size() - 1) {
            var11 = var9;
            break;
         }
   ...
   private void recomputeScrollPosition(int var1, int var2, int var3, int var4) {
      ...
      if(var2 > 0 && !this.mItems.isEmpty()) {
         if(!this.mScroller.isFinished()) {
            ...
            var5 = (float)this.getScrollX() / (float)(var2 - var8 - var6 + var4);
            this.scrollTo((int)((float)(var1 - var9 - var7 + var3) * var5), this.getScrollY());
         }
      } else {
   ...
   public void addFocusables(ArrayList var1, int var2, int var3) {
      ...
      if((var5 != 262144 || var6 == var1.size()) && this.isFocusable() && ((var3 & 1) != 1 || !this.isInTouchMode() || this.isFocusableInTouchMode()) && var1 != null) {
         var1.add(this);
      }
   ...
   public void computeScroll() {
      ...
      if(!this.mScroller.isFinished() && this.mScroller.computeScrollOffset()) {
         ...
         if(var4 != var2 || var3 != var1) {
            this.scrollTo(var2, var1);
   ...
   public void draw(Canvas var1) {
      ...
      if(var4 != 0 && (var4 != 1 || this.mAdapter == null || this.mAdapter.getCount() <= 1)) {
         ...
         if(!this.mRightEdge.isFinished()) {
            ...
            this.mRightEdge.setSize(var6 - var7 - var5, var9);
   ...
   public void endFakeDrag() {
      if(!this.mFakeDragging) {
         ...
         if(this.mAdapter != null) {
            ...
            int var2 = (int)VelocityTrackerCompat.getXVelocity(var4, this.mActivePointerId);
            this.mPopulatePending = true;
            int var1 = this.getClientWidth();
            int var3 = this.getScrollX();
            ViewPager.ItemInfo var5 = this.infoForCurrentScrollPosition();
            this.setCurrentItemInternal(this.determineTargetPage(var5.position, ((float)var3 / (float)var1 - var5.offset) / var5.widthFactor, var2, (int)(this.mLastMotionX - this.mInitialMotionX)), true, true, var2);
         }
      ...
      ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() {
         ...
         public WindowInsetsCompat onApplyWindowInsets(View var1, WindowInsetsCompat var2) {
            ...
            if(!var6.isConsumed()) {
               ...
               var6 = var6.replaceSystemWindowInsets(var7.left, var7.top, var7.right, var7.bottom);
            }
   ...
   protected void onDraw(Canvas var1) {
      ...
      if(this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
         ...
         int var8 = this.getWidth();
         float var4 = (float)this.mPageMargin / (float)var8;
         int var7 = 0;
         ...
         for(int var9 = ((ViewPager.ItemInfo)this.mItems.get(var11 - 1)).position; var6 < var9; ++var6) {
            while(var6 > var12.position && var7 < var11) {
            ...
            if(var6 == var12.position) {
               var3 = (var12.offset + var12.widthFactor) * (float)var8;
            ...
            if((float)this.mPageMargin + var3 > (float)var10) {
      ...
      if(var7 != 3 && var7 != 1) {
         ...
         case 2:
            ...
            if(var7 != -1) {
               ...
               float var6 = var4 - this.mLastMotionX;
               var2 = Math.abs(var6);
               float var3 = var1.getY(var7);
               float var5 = Math.abs(var3 - this.mInitialMotionY);
               if(var6 != 0.0F && !this.isGutterDrag(this.mLastMotionX, var6) && this.canScroll(this, false, (int)var6, (int)var4, (int)var3)) {
               ...
               if(var2 > (float)this.mTouchSlop && 0.5F * var2 > var5) {
                  this.mIsBeingDragged = true;
                  this.requestParentDisallowInterceptTouchEvent(true);
                  this.setScrollState(1);
                  if(var6 > 0.0F) {
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      for(int var9 = 0; var9 < var13; var2 = var4) {
         ...
         if(var18.getVisibility() != 8) {
            ...
            if(var17.isDecor) {
               ...
               case 3:
                  var4 = var3;
                  var7 = var3 + var18.getMeasuredWidth();
                  break;
               case 5:
                  var4 = var15 - var6 - var18.getMeasuredWidth();
      ...
      for(var4 = 0; var4 < var13; ++var4) {
         ...
         if(var20.getVisibility() != 8) {
            ViewPager.LayoutParams var19 = (ViewPager.LayoutParams)var20.getLayoutParams();
            if(!var19.isDecor) {
               ViewPager.ItemInfo var21 = this.infoForChild(var20);
               if(var21 != null) {
                  var7 = var3 + (int)((float)var6 * var21.offset);
                  if(var19.needsMeasure) {
                     var19.needsMeasure = false;
                     var20.measure(MeasureSpec.makeMeasureSpec((int)((float)var6 * var19.widthFactor), 1073741824), MeasureSpec.makeMeasureSpec(var14 - var2 - var5, 1073741824));
                  }
         ...
         if(var13.getVisibility() != 8) {
            ...
            if(var14 != null) {
               ...
               if(var14.isDecor) {
                  ...
                  var13.measure(MeasureSpec.makeMeasureSpec(var4, var9), MeasureSpec.makeMeasureSpec(var3, var10));
                  if(var15) {
   ...
   protected void onPageScrolled(int var1, float var2, int var3) {
      ...
      if(this.mDecorChildCount > 0) {
         ...
         int var5;
         for(int var7 = 0; var7 < var9; var6 = var5) {
            ...
            if(!var13.isDecor) {
               ...
               case 1:
                  var5 = Math.max((var10 - var14.getMeasuredWidth()) / 2, var4);
                  break;
               case 2:
               case 4:
               default:
               ...
               case 3:
                  ...
                  break;
               case 5:
                  var5 = var10 - var6 - var14.getMeasuredWidth();
   ...
   protected boolean onRequestFocusInDescendants(int var1, Rect var2) {
      ...
      while(true) {
         ...
         if(var7.getVisibility() == 0) {
            ViewPager.ItemInfo var8 = this.infoForChild(var7);
            if(var8 != null && var8.position == this.mCurItem && var7.requestFocus(var1, var2)) {
               var6 = true;
               break;
            }
         }
      ...
      if(this.mFakeDragging) {
         ...
         case 1:
            ...
            if(this.mIsBeingDragged) {
               ...
               int var7 = (int)VelocityTrackerCompat.getXVelocity(var12, this.mActivePointerId);
               this.mPopulatePending = true;
               int var8 = this.getClientWidth();
               var6 = this.getScrollX();
               ViewPager.ItemInfo var13 = this.infoForCurrentScrollPosition();
               var2 = (float)this.mPageMargin / (float)var8;
               this.setCurrentItemInternal(this.determineTargetPage(var13.position, ((float)var6 / (float)var8 - var13.offset) / (var13.widthFactor + var2), var7, (int)(var1.getX(var1.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, var7);
         ...
         case 2:
            if(!this.mIsBeingDragged) {
               ...
               float var4 = Math.abs(var5 - this.mLastMotionX);
               float var3 = var1.getY(var6);
               var2 = Math.abs(var3 - this.mLastMotionY);
               if(var4 > (float)this.mTouchSlop && var4 > var2) {
                  this.mIsBeingDragged = true;
                  this.requestParentDisallowInterceptTouchEvent(true);
