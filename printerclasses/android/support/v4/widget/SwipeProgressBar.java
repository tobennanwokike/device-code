...
final class SwipeProgressBar {
   ...
   void draw(Canvas var1) {
      ...
      if(!this.mRunning && this.mFinishTime <= 0L) {
         ...
         long var14 = this.mStartTime;
         long var10 = (var12 - this.mStartTime) / 2000L;
         float var2 = (float)((var12 - var14) % 2000L) / 20.0F;
         float var3;
         if(!this.mRunning) {
            if(var12 - this.mFinishTime >= 1000L) {
               this.mFinishTime = 0L;
               return;
            }

            var3 = (float)((var12 - this.mFinishTime) % 1000L) / 10.0F / 100.0F;
