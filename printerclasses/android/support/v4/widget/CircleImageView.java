...
class CircleImageView extends ImageView {
   ...
   CircleImageView(Context var1, int var2) {
      ...
      if(this.elevationSupported()) {
         ...
         ViewCompat.setLayerType(this, 1, var6.getPaint());
   ...
   private class OvalShadow extends OvalShape {
      ...
      private void updateRadialGradient(int var1) {
         ...
         this.mRadialGradient = new RadialGradient(var2, var4, var3, new int[]{1023410176, 0}, (float[])null, var5);
         this.mShadowPaint.setShader(this.mRadialGradient);
      }

      public void draw(Canvas var1, Paint var2) {
         int var4 = CircleImageView.this.getWidth();
         int var3 = CircleImageView.this.getHeight();
         var1.drawCircle((float)(var4 / 2), (float)(var3 / 2), (float)(var4 / 2), this.mShadowPaint);
         var1.drawCircle((float)(var4 / 2), (float)(var3 / 2), (float)(var4 / 2 - CircleImageView.this.mShadowRadius), var2);
      }
