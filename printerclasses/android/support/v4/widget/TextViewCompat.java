...
public final class TextViewCompat {
   ...
   static class BaseTextViewCompatImpl implements TextViewCompat.TextViewCompatImpl {
      public Drawable[] getCompoundDrawablesRelative(@NonNull TextView var1) {
         return TextViewCompatGingerbread.getCompoundDrawablesRelative(var1);
      }

      public int getMaxLines(TextView var1) {
         return TextViewCompatGingerbread.getMaxLines(var1);
      }

      public int getMinLines(TextView var1) {
         return TextViewCompatGingerbread.getMinLines(var1);
      }
      ...
      public void setTextAppearance(TextView var1, @StyleRes int var2) {
         TextViewCompatGingerbread.setTextAppearance(var1, var2);
      }
   }

   static class JbMr1TextViewCompatImpl extends TextViewCompat.JbTextViewCompatImpl {
      public Drawable[] getCompoundDrawablesRelative(@NonNull TextView var1) {
         return TextViewCompatJbMr1.getCompoundDrawablesRelative(var1);
      }
   ...
   static class JbMr2TextViewCompatImpl extends TextViewCompat.JbMr1TextViewCompatImpl {
      public Drawable[] getCompoundDrawablesRelative(@NonNull TextView var1) {
         return TextViewCompatJbMr2.getCompoundDrawablesRelative(var1);
      }
   ...
   interface TextViewCompatImpl {
      Drawable[] getCompoundDrawablesRelative(@NonNull TextView var1);
