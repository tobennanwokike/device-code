...
class MaterialProgressDrawable extends Drawable implements Animatable {
   ...
   private void setupAnimators() {
      final MaterialProgressDrawable.Ring var2 = this.mRing;
      Animation var1 = new Animation() {
         public void applyTransformation(float var1, Transformation var2x) {
            if(MaterialProgressDrawable.this.mFinishing) {
               MaterialProgressDrawable.this.applyFinishTranslation(var1, var2);
            } else {
               float var3 = MaterialProgressDrawable.this.getMinProgressArc(var2);
               float var5 = var2.getStartingEndTrim();
               float var6 = var2.getStartingStartTrim();
               float var4 = var2.getStartingRotation();
               MaterialProgressDrawable.this.updateRingColor(var1, var2);
               if(var1 <= 0.5F) {
                  float var7 = var1 / 0.5F;
                  var7 = MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(var7);
                  var2.setStartTrim(var6 + (0.8F - var3) * var7);
               }

               if(var1 > 0.5F) {
                  var6 = (var1 - 0.5F) / 0.5F;
                  var6 = MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(var6);
                  var2.setEndTrim(var5 + var6 * (0.8F - var3));
               }

               var2.setRotation(var4 + 0.25F * var1);
               var3 = MaterialProgressDrawable.this.mRotationCount / 5.0F;
               MaterialProgressDrawable.this.setRotation(216.0F * var1 + 1080.0F * var3);
            }
   ...
   public boolean isRunning() {
      ArrayList var4 = this.mAnimators;
      int var2 = var4.size();
      int var1 = 0;
      ...
      while(true) {
         ...
         Animation var5 = (Animation)var4.get(var1);
         if(var5.hasStarted() && !var5.hasEnded()) {
            var3 = true;
            break;
         }
   ...
   private static class Ring {
      ...
      private void drawTriangle(Canvas var1, float var2, float var3, Rect var4) {
         if(this.mShowArrow) {
            ...
            float var7 = (float)((int)this.mStrokeInset / 2);
            float var8 = this.mArrowScale;
            float var6 = (float)(this.mRingCenterRadius * Math.cos(0.0D) + (double)var4.exactCenterX());
            float var5 = (float)(this.mRingCenterRadius * Math.sin(0.0D) + (double)var4.exactCenterY());
            ...
            this.mArrow.offset(var6 - var7 * var8, var5);
            this.mArrow.close();
      ...
      public void draw(Canvas var1, Rect var2) {
         ...
         float var4 = (this.mStartTrim + this.mRotation) * 360.0F;
         float var3 = (this.mEndTrim + this.mRotation) * 360.0F - var4;
         this.mPaint.setColor(this.mCurrentColor);
         var1.drawArc(var5, var4, var3, false, this.mPaint);
         this.drawTriangle(var1, var4, var3, var2);
         if(this.mAlpha < 255) {
